...
- The DS [RAM Unlocking API](https://forum.gbadev.org/viewtopic.php?f=18&t=13023) - dead download links now, but the latest v1.3 code can be found in **ram.c** in [memtestARM](http://pineight.com/ds/#memtestARM)
